...
$(function(){
	...
	$('.trigger-navigation').waypoint(function(direction) {

		// When scrolling down the page, show the navigation once the header has left the screen
		if (direction === 'down') {
			$("#nav-maxi").removeClass("outofview fadeOutUpBig");
			$("#nav-maxi").addClass("inview fadeInDownBig");

			// Since the video won't be visible, we'll pause it
			// document.getElementById('video').pause();

			// Exploding MFAR logo
			$(".hex-box").addClass("animated");
		}

		// When scrolling back up the page, remove the navigation
		if (direction === 'up') {
			$("#nav-maxi").removeClass("inview fadeInDownBig");
			$("#nav-maxi").addClass("outofview fadeOutUpBig");
			// Make the video play, once again
